...
local source = radio.RawFileSource('bits.txt', radio.types.Bit,5000, true)
-- local source = radio.UniformRandomSource(radio.types.Bit, 300)
local bfsk = BFSKModulator(25e3 , 576e3)

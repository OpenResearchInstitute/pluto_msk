...
| 0x0010     | 0:31         | input          |csr_array(4)                     | freq_word_ft   | value of the frequency for symbol time (mapped to freq_word_tclk)| 
| 0x0014     | 0:31         | input          |csr_array(5)                     | freq_word_f1   | value of the frequency for the lower MSK tone |
| 0x0018     | 0:31         | input          |csr_array(6)                     | freq_word_f2   | value of the frequency for the higher MSK tone |

...
class MemoryReadOnlyLegacyArray(NodeArray[MemoryReadOnlyLegacy], ABC):
    """
    base class for an array of read only memories
    """
    __slots__: list[str] = []
    ...
    def __init__(self, *,
                 ...
                 dimensions: tuple[int, ...],
                 elements: Optional[tuple[tuple[tuple[int, ...], ...],
                 tuple[MemoryReadOnlyLegacy, ...]]] = None
                 ):
...
class MemoryWriteOnlyLegacyArray(NodeArray[MemoryWriteOnlyLegacy], ABC):
    """
    base class for an array of write only memories
    """
    __slots__: list[str] = []
    ...
    def __init__(self, *,
                 ...
                 dimensions: tuple[int, ...],
                 elements: Optional[tuple[tuple[tuple[int, ...], ...],
                 tuple[MemoryWriteOnlyLegacy, ...]]] = None
                 ):
...
class MemoryReadWriteLegacyArray(NodeArray[MemoryReadWriteLegacy], ABC):
    """
    base class for an array of read and write memories
    """
    __slots__: list[str] = []
    ...
    def __init__(self, *,
                 ...
                 dimensions: tuple[int, ...],
                 elements: Optional[tuple[tuple[tuple[int, ...], ...],
                 tuple[MemoryReadWriteLegacy, ...]]] = None):
...
MemoryNonLegacyArray = Union[MemoryReadOnlyArray, MemoryWriteOnlyArray, MemoryReadWriteArray]
MemoryLegacyArray = Union[MemoryReadOnlyLegacyArray, MemoryWriteOnlyLegacyArray,
                          MemoryReadWriteLegacyArray]
MemoryArray = Union[MemoryNonLegacyArray, MemoryLegacyArray]
